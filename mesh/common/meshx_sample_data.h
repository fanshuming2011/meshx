...
#define MESHX_NET_KEY  {0x7d, 0xd7, 0x36, 0x4c, 0xd8, 0x42, 0xad, 0x18, 0xc1, 0x7c, 0x2b, 0x82, 0x0c, 0x84, 0xc3, 0xd6}
#define MESHX_NET_KEY1 {0xef, 0xb2, 0x25, 0x5e, 0x64, 0x22, 0xd3, 0x30, 0x08, 0x8e, 0x09, 0xbb, 0x01, 0x5e, 0xd7, 0x07}

#define MESHX_APP_KEY   {0x63, 0x96, 0x47, 0x71, 0x73, 0x4f, 0xbd, 0x76, 0xe3, 0xb4, 0x05, 0x19, 0xd1, 0xd9, 0x4a, 0x48}

static meshx_provision_data_t prov_data =
{
    .network_key = MESHX_NET_KEY1,
    .key_index = 0x0567,
    .key_refresh_flag = 0,
    .iv_update_flag = 0,
    .rfu = 0,
